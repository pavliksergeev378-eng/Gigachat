...
(function (global) {
  ...
  global.addEventListener('storage', function (e) {
    ...
    if (e.newValue !== getCurrentTheme()) {
      ...
      if (document.body) document.body.classList.toggle('dark', e.newValue === 'dark');
      updateThemeToggleIcon();
      syncHljsTheme();
    }
  });
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', function () {
      document.body.classList.toggle('dark', getCurrentTheme() === 'dark');
      syncHljsTheme();
      initThemeToggle();
  ...
  function injectAttachCss() {
    ...
    var css = ''
      ...
      + '.gc-input-wrap > textarea:focus{border-color:#4a4a48 !important;box-shadow:0 0 4px rgba(96,120,129,.10) !important}'
  ...
  function injectToolCss() {
    ...
    var css =
      ...
      '.reset-btn button:hover{background:var(--accent-light,rgba(96,120,129,.18));color:var(--accent);border-color:var(--accent)}' +
  ...
  function injectAgentCss() {
    ...
    var css =
      ...
      '.btn-export:hover{background:var(--accent-light,rgba(96,120,129,.18));color:var(--accent);border-color:var(--accent)}' +
      // .msg общие
  ...
  function injectVoiceCss() {
    ...
    st.textContent =
      ...
      '.gc-reg-hint .gc-reg-ic{flex-shrink:0;width:32px;height:32px;border-radius:50%;display:flex;align-items:center;justify-content:center;background:var(--accent-light,rgba(29,65,78,0.15));color:var(--accent)}' +
